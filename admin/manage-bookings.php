...
if(isset($_REQUEST['aeid'])){
	...
	$body = "Yout booking is confirmed!! Wait for owners call for further details.";
...
<head>
	...
	<title>Shree cottages  |Admin Manage booking   </title>
...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->Posti);?></td>
											<td><?php 
if($result->Status==0)
{
