      ...
      <table class="table text-center">
        <thead>
          <tr>
            ...
            <th style="width: 16.5%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Marrige</th>
            <th style="width: 16.5%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Engagement</th>
            <th style="width: 16.5%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Birthday Party</th>
            <th style="width: 16.5%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Conference Meeting</th>
          </tr>
        </thead>
        <tbody>
          <tr>
							...
							<form action="payscript.php" method="POST">
								...
								<div class="row">
									...
									<div class="row">
										...
										<div class="form-btn">
										  <button src='payscript.php' class="submit-btn" name="BookNow" onclick="showA()">Book Now</button>
										</div>
